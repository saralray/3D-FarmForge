...
**Printer polling:** The Python poller queries all active printers from PostgreSQL, makes HTTP requests to each printer, and applies an offline grace period (`PRINTER_OFFLINE_GRACE_SECONDS`, default 30 s) before marking a printer offline. Supports two printer profiles: generic and Snapmaker U1.
